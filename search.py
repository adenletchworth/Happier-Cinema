...
class IndexSearch:
    ...
    def search(self, query, k=5, genre_filter=None, min_vote_average=None, after_year=None, before_year=None, initial_k=10, max_k=1000):
        ...
        for result in filtered_results:
            ...
            formatted_result = f"{result.metadata['title']} ({release_year}) - {result.metadata['genre']}"
            formatted_results.append(formatted_result)
        
        return formatted_results if formatted_results else ["No results match the given filters."]
